...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseError> handlerResourceNotFoundException(ResourceNotFoundException exception, HttpServletRequest request){
        ResponseError error = this.createResponseError(HttpStatus.NOT_FOUND, exception.getMessage(), request, null);
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
    }

    @ExceptionHandler(BusinessException.class)
    public ResponseEntity<ResponseError> handlerBusinessException(BusinessException exception, HttpServletRequest request){
    ...
    public ResponseEntity<ResponseError> handlerMethodArgumentNotValidException(MethodArgumentNotValidException exceptions, HttpServletRequest request){
